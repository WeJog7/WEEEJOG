...
/**
 * Servlet implementation class FriendProfilWeekServlet
 */

@WebServlet(urlPatterns = {"/user/friendProfil", "/admin/friendProfil"})
public class FriendProfilWeekServlet extends AbstractGenericServlet {
